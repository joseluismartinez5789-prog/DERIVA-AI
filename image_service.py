...
- Escribe todas las expresiones matemáticas con LaTeX.
- Usa $...$ para fórmulas breves y $$...$$ para ecuaciones importantes.
- Nunca dejes una expresión matemática sin delimitadores.
...
Presenta una transformación matemática por línea y define los símbolos
