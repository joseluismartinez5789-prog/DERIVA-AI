        ...
        if not correo_google:
            ...
            try:
                ...
                if curso_google:
                    ...
                    st.info(
                        "Elige si deseas aprender por tu cuenta o entrar "
                        "a un curso mediante el código de un profesor."
                    )

                    opcion_estudiante = st.radio(
                        "¿Cómo deseas utilizar DERIVA AI?",
                        [
                            "Aprender por mi cuenta",
                            "Entrar a un curso",
                        ],
                        key="opcion_tipo_estudiante",
                    )

                    if opcion_estudiante == "Entrar a un curso":
                        with st.form(
                        ...
                        if st.button(
                            "Comenzar a aprender por mi cuenta",
                            use_container_width=True,
                            type="primary",
